...
async function main() {
  ...
  await db.insert(schema.properties).values({
    ...
    settings: {
      ...
      noShowCutoffHour: 18,
      guestInfo: {
        pets: 'Проживание с питомцами согласуйте заранее с администрацией.',
        children: 'Можно приехать с детьми; укажите их возраст и запрос на дополнительное место при бронировании.',
        parking: 'Парковка для гостей на территории; доступность места уточняйте перед приездом.',
        breakfast: 'Завтрак можно добавить к проживанию; состав и стоимость уточняйте при бронировании.',
        restaurant: 'По вопросам питания и бронирования столика обратитесь к администрации.',
        spa: 'SPA-процедуры доступны по предварительной записи; наличие свободного времени уточняйте заранее.',
        bath: 'Посещение бани согласовывается отдельно; условия и свободное время уточняйте заранее.',
        transfer: 'Трансфер возможен по предварительному запросу; сообщите маршрут и время прибытия.',
        smoking: 'Условия для курящих и расположение специально отведённых мест уточняйте у администрации.',
        wifi: 'Wi-Fi доступен гостям; данные для подключения предоставят при заселении.',
      },
    },
  });
